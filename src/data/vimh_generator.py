...
This module provides functionality to generate VIMH format datasets with characteristics similar to
CIFAR-100, including multiple classification heads and configurable complexity levels.
"""
...
def generate_cifar100_like_vimh(
    ...
    Creates a synthetic multihead dataset that mimics CIFAR-100 complexity but with additional
    classification heads for research purposes.
...
def _generate_correlated_labels(
    ...
    Creates realistic correlations between different classification heads, similar to how
    fine/coarse labels relate in CIFAR-100.
