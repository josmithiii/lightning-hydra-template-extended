"""Architecture Utilities for Lightning-Hydra-Template.

This module provides general-purpose utilities for architecture metadata extraction, storage, and
model configuration. It centralizes logic for architecture analysis and configuration across
