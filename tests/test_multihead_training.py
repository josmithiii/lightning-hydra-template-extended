...
def mock_cifar100mh_data():
    ...
    return {"data": images, "cifar100mh_labels": labels}
...
class TestMultiheadLitModule:
    ...
    def test_init_with_explicit_criteria(self):
        ...
        net = TestMultiheadNet()
        criteria = {"param_0": nn.CrossEntropyLoss(), "param_1": nn.CrossEntropyLoss()}
...
class TestCIFAR100MHDataModule:
    ...
    def test_init(self):
        ...
        dm = CIFAR100MHDataModule(data_dir="test_dir", batch_size=32, num_workers=0)
    ...
    def test_setup_and_dataloaders(self, temp_dir, mock_cifar100mh_data, mock_metadata):
        ...
        dm = CIFAR100MHDataModule(data_dir=str(temp_dir), batch_size=4, num_workers=0)
        ...
        assert (
            dm.heads_config["param_1"] == 19
        )  # 0-18 + 1 (max value in test data: (19*2)%19=18, so max=18)
...
class TestMultiheadTrainingIntegration:
    ...
    def test_auto_configure_from_dataset(self, temp_dir, mock_cifar100mh_data, mock_metadata):
        ...
        net = TestMultiheadNet(
            heads_config={"param_0": 100, "param_1": 100}
    ...
    def test_checkpoint_save_load(self, temp_dir, mock_cifar100mh_data, mock_metadata):
        ...
        checkpoint_callback = ModelCheckpoint(
            dirpath=str(temp_dir), filename="test_checkpoint", save_top_k=1, monitor="val/loss"
        )
...
class TestVIMHTrainingIntegration:
    ...
    def test_vimh_training_integration(self, temp_dir):
        ...
        # Create model with auto-configuration
        net = SimpleCNN(input_channels=3, heads_config={"note_number": 256, "note_velocity": 256})
    ...
    def test_vimh_single_parameter_training(self, temp_dir):
        ...
        # Create model
        net = SimpleCNN(input_channels=3, heads_config={"note_number": 256})
    ...
    def test_vimh_variable_image_size_training(self, temp_dir):
        ...
        net = SimpleCNN(input_channels=1, heads_config={"digit_class": 256})  # Grayscale
