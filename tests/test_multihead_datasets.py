...
from src.data.generic_multihead_dataset import (
    GenericMultiheadDataset,
    MultiheadDatasetFactory,
)
...
def create_test_dataset_files(temp_dir: Path, mock_data: dict, mock_metadata: dict):
    ...
    train_data = {"data": mock_data["data"][:8], "cifar100mh_labels": mock_data["labels"][:8]}
    test_data = {"data": mock_data["data"][8:], "cifar100mh_labels": mock_data["labels"][8:]}
